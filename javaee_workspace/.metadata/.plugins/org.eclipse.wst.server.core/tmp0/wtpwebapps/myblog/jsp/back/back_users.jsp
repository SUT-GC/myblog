                                ...
                                <table class="table table-striped table-bordered" id="example">
                                    ...
                                    <tbody class="table_content">
                                        ...
                                        <tr class="gradeA">
                                            ...
                                            <a href="/myblog/UserEditOrDelete?com=delete&userid=<%=user.getUser_id()%>"><button class="btn btn-danger button_delete"><i class="glyphicon glyphicon-remove glyphicon-white"></i> Delete</button></a></td>
                                        </tr>
                                        <%} %>
                                    </tbody>
                                </table>
