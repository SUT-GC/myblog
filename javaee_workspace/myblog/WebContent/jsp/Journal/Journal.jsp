...
<!-- java end -->
		<div class="container">
			<section class="grid-wrap">
				...
				%>
					<li><a href="journal_each.jsp?id=<%=journal.getJournal_id()%>"><img style='width:300px; height:340px;' src="/myblog/image/journalheader/4.jpg" alt="img01"><h3><%=journal.getTitle()%></h3></a></li>
				<%
					}
				%>
				</ul>
